...
class ResumeFilterWithoutPosition(django_filters.FilterSet):
...
class ResumeFilterWithoutDate(django_filters.FilterSet):
...
class ResumeFilterWithoutStatus(django_filters.FilterSet):
    position = django_filters.CharFilter("vacancy__position__name", 'icontains', label='Должность')
